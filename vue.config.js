...
module.exports = {
  ...
  configureWebpack: (config) => {
    ...
    // eg. `/user/:id` -> `/user/alex`
      const renderRoutes = [
        '/index.html', '/contact.html', '/member.html', '/404.html', '/news/list.html', '/header+footer.html', '/news/content.html', '/shop/list.html', '/shop/content.html', '/menu/list.html', '/menu/content.html', '/event.html'
      ]
